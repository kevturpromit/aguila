odoo.define('flexipharmacy.models', function (require) {
	...
	models.load_fields("res.users", ['image_small','login','company_ids','access_ereceipt','access_quick_cash_payment',
	                                 ...
	                                 'access_pos_dashboard','access_product_expiry_report','shop_ids','display_own_sales_order', 'user_role']);
    ...
    models.load_fields("pos.order", ['order_make_picking','pos_salesperson_id'], ['picking_id']);
	...
	models.Order = models.Order.extend({
		...
		get_pos_salesperson: function(){
			...
			if (order != null){
				...
				var order_data = this.pos.db.get_order_by_id(order_id)
				if (order_data != undefined){
					return order_data.pos_salesperson_id[0]
				}else{
...
//            		  var change = this.get_total_paid() - this.getNetTotalTaxIncluded() - this.get_order_total_discount();
	    ...
	    export_as_JSON: function() {
            ...
            var new_val = {
				...
				pos_xml_receipt_payment_lines: this.get_pos_xml_receipt_payment_lines() || '',
				pos_xml_receipt_taxes_lines: this.get_pos_xml_receipt_taxes_lines() || '',
            }
		...
		set_pos_xml_receipt_payment_lines: function(pos_xml_receipt_payment_lines){
        	this.pos_xml_receipt_payment_lines = pos_xml_receipt_payment_lines;
        },
        get_pos_xml_receipt_payment_lines: function(){
        	return this.pos_xml_receipt_payment_lines;
        },

		set_pos_xml_receipt_taxes_lines: function(pos_xml_receipt_taxes_lines){
        	this.pos_xml_receipt_taxes_lines = pos_xml_receipt_taxes_lines;
        },
        get_pos_xml_receipt_taxes_lines: function(){
        	return this.pos_xml_receipt_taxes_lines;
        },
